...
define('PRODUCTION_CERTIFICATE_KEY', 'CloudCenter/certificate_sandbox.key');
define('PRODUCTION_CERTIFICATE_PATH', 'CloudCenter/certificate_sandbox.pem');

// This is the password you were asked to create in terminal when you extracted ApplePay.key.pem
define('PRODUCTION_CERTIFICATE_KEY_PASS', '*#06#171049');
...
// if the above line isn't working for you for some reason, comment it out and uncomment the next line instead, entering in your merchant identifier you created in your apple developer account
 define('PRODUCTION_MERCHANTIDENTIFIER', 'merchant.sandbox.wondershare.cloudservice');
...
define('PRODUCTION_DISPLAYNAME', 'Test Applepay');
